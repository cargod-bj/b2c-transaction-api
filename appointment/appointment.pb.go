...
type AppointmentCondition struct {
	...
	FromTime    uint64   `protobuf:"varint,14,opt,name=fromTime,proto3" json:"fromTime,omitempty"`
	ToTime      uint64   `protobuf:"varint,15,opt,name=toTime,proto3" json:"toTime,omitempty"`
}
...
func (x *AppointmentCondition) GetFromTime() uint64 {
	if x != nil {
		return x.FromTime
	}
	return 0
...
func (x *AppointmentCondition) GetToTime() uint64 {
	if x != nil {
		return x.ToTime
	}
	return 0
...
var file_appointment_appointment_proto_rawDesc = []byte{
	...
	0x0e, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x66, 0x72, 0x6f, 0x6d, 0x54, 0x69, 0x6d, 0x65, 0x12,
	0x16, 0x0a, 0x06, 0x74, 0x6f, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x04, 0x52,
