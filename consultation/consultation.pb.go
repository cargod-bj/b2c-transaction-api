...
type BatchUpdateRequest struct {
	...
	ConsultationStatus uint64   `protobuf:"varint,3,opt,name=ConsultationStatus,proto3" json:"ConsultationStatus,omitempty"`
...
func (x *BatchUpdateRequest) GetConsultationStatus() uint64 {
	if x != nil {
		return x.ConsultationStatus
	}
	return 0
...
func (x *BatchUpdateRequest) GetStatus() uint64 {
	if x != nil {
		return x.Status
	}
	return 0
...
var file_consultation_consultation_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x12, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6c, 0x74, 0x61,
	...
	0x28, 0x04, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0xac, 0x03, 0x0a, 0x0c, 0x43,
