...
var file_order_order_proto_rawDesc = []byte{
	...
	0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xef, 0x02, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12,
...
var file_order_order_proto_goTypes = []interface{}{
	...
	(*payment.PaymentList)(nil),          // 13: payment.PaymentList
...
var file_order_order_proto_depIdxs = []int32{
	...
	11, // 3: order.OrderCheckList.checkLists:type_name -> orderCheckList.CheckListDto
	1,  // 4: order.OrderDetail.orderDto:type_name -> order.OrderDTO
	12, // 5: order.OrderDetail.orderFees:type_name -> orderFee.OrderFeeDto
	13, // 6: order.OrderDetail.paymentDtos:type_name -> payment.PaymentList
	7,  // 7: order.OrderDetail.orderCheckList:type_name -> order.OrderCheckList
	14, // 8: order.OrderDetail.orderRefund:type_name -> orderRefund.OrderRefundDto
	15, // 9: order.OrderDetail.orderFlowLogs:type_name -> orderFlowLog.OrderFlowLogDto
	...
	4,  // 17: order.Order.Add:output_type -> order.Response
	4,  // 18: order.Order.Delete:output_type -> order.Response
	4,  // 19: order.Order.Update:output_type -> order.Response
	4,  // 20: order.Order.GetList:output_type -> order.Response
	4,  // 21: order.Order.GetDetail:output_type -> order.Response
	4,  // 22: order.Order.CancelOrder:output_type -> order.Response
	4,  // 23: order.Order.SaveDeliveryInfo:output_type -> order.Response
