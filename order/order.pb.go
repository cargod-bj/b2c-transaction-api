...
var file_order_order_proto_rawDesc = []byte{
	...
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x04, 0x52, 0x03, 0x69, 0x64, 0x73, 0x32, 0x8a, 0x05, 0x0a,
	...
	0x47, 0x65, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x57, 0x69, 0x74, 0x68, 0x50, 0x61, 0x79, 0x12, 0x15,
...
var file_order_order_proto_depIdxs = []int32{
	...
	4,  // 22: order.Order.GetListWithPay:input_type -> order.OrderCondition
	5,  // 23: order.Order.Add:output_type -> order.Response
	5,  // 24: order.Order.Delete:output_type -> order.Response
	5,  // 25: order.Order.Update:output_type -> order.Response
	5,  // 26: order.Order.GetList:output_type -> order.Response
	5,  // 27: order.Order.GetDetail:output_type -> order.Response
	5,  // 28: order.Order.CancelOrder:output_type -> order.Response
	5,  // 29: order.Order.SaveDeliveryInfo:output_type -> order.Response
	19, // 30: order.Order.UpdateOrderStatus:output_type -> common.Response
	19, // 31: order.Order.UpdateCost:output_type -> common.Response
	19, // 32: order.Order.ChangeCar:output_type -> common.Response
	19, // 33: order.Order.CheckCarInvalidInOrder:output_type -> common.Response
	19, // 34: order.Order.GetListWithPay:output_type -> common.Response
