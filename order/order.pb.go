...
type OrderCondition struct {
	...
	MultiStatus         []uint32 `protobuf:"varint,18,rep,packed,name=multiStatus,proto3" json:"multiStatus,omitempty"` //状态数组
}
...
func (x *OrderCondition) GetMultiStatus() []uint32 {
	if x != nil {
...
var file_order_order_proto_rawDesc = []byte{
	...
	0x03, 0x28, 0x0d, 0x52, 0x0b, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
