...
var file_order_order_proto_rawDesc = []byte{
	...
	0x32, 0x89, 0x07, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x29, 0x0a, 0x03, 0x41, 0x64,
...
var file_order_order_proto_goTypes = []interface{}{
	...
	(*orderCheckList.CheckListDto)(nil),  // 15: orderCheckList.CheckListDto
	(*orderFee.OrderFeeDto)(nil),         // 16: orderFee.OrderFeeDto
	(*payment.PaymentList)(nil),          // 17: payment.PaymentList
	(*orderRefund.OrderRefundDto)(nil),   // 18: orderRefund.OrderRefundDto
	(*orderFlowLog.OrderFlowLogDto)(nil), // 19: orderFlowLog.OrderFlowLogDto
...
var file_order_order_proto_depIdxs = []int32{
	...
	14, // 3: order.Response.data:type_name -> google.protobuf.Any
	15, // 4: order.OrderCheckList.checkLists:type_name -> orderCheckList.CheckListDto
	1,  // 5: order.OrderDetail.orderDto:type_name -> order.OrderDTO
	16, // 6: order.OrderDetail.orderFees:type_name -> orderFee.OrderFeeDto
	17, // 7: order.OrderDetail.paymentDtos:type_name -> payment.PaymentList
	9,  // 8: order.OrderDetail.orderCheckList:type_name -> order.OrderCheckList
	18, // 9: order.OrderDetail.orderRefund:type_name -> orderRefund.OrderRefundDto
	19, // 10: order.OrderDetail.orderFlowLogs:type_name -> orderFlowLog.OrderFlowLogDto
	...
	6,  // 27: order.Order.Add:output_type -> order.Response
	6,  // 28: order.Order.Delete:output_type -> order.Response
	6,  // 29: order.Order.Update:output_type -> order.Response
	6,  // 30: order.Order.GetList:output_type -> order.Response
	6,  // 31: order.Order.GetDetail:output_type -> order.Response
	6,  // 32: order.Order.CancelOrder:output_type -> order.Response
	6,  // 33: order.Order.SaveDeliveryInfo:output_type -> order.Response
	20, // 34: order.Order.UpdateOrderStatus:output_type -> common.Response
	20, // 35: order.Order.UpdateCost:output_type -> common.Response
	20, // 36: order.Order.ChangeCar:output_type -> common.Response
	20, // 37: order.Order.CheckCarInvalidInOrder:output_type -> common.Response
	20, // 38: order.Order.GetNoAssignCustomerByOrder:output_type -> common.Response
	20, // 39: order.Order.GetListWithPay:output_type -> common.Response
	20, // 40: order.Order.AssignOrderPIC:output_type -> common.Response
	20, // 41: order.Order.CancelOnlineOrder:output_type -> common.Response
	20, // 42: order.Order.GetPayInfo:output_type -> common.Response
