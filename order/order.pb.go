...
var file_order_order_proto_rawDesc = []byte{
	...
	0x07, 0x72, 0x65, 0x6d, 0x61, 0x72, 0x6b, 0x73, 0x32, 0x96, 0x04, 0x0a, 0x05, 0x4f, 0x72, 0x64,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x36, 0x0a, 0x09, 0x43, 0x68, 0x61,
	0x6e, 0x67, 0x65, 0x43, 0x61, 0x72, 0x12, 0x15, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x4f,
...
var file_order_order_proto_depIdxs = []int32{
	...
	3,  // 19: order.Order.ChangeCar:input_type -> order.OrderCondition
	4,  // 20: order.Order.Add:output_type -> order.Response
	4,  // 21: order.Order.Delete:output_type -> order.Response
	4,  // 22: order.Order.Update:output_type -> order.Response
	4,  // 23: order.Order.GetList:output_type -> order.Response
	4,  // 24: order.Order.GetDetail:output_type -> order.Response
	4,  // 25: order.Order.CancelOrder:output_type -> order.Response
	4,  // 26: order.Order.SaveDeliveryInfo:output_type -> order.Response
	17, // 27: order.Order.UpdateOrderStatus:output_type -> common.Response
	17, // 28: order.Order.UpdateCost:output_type -> common.Response
	17, // 29: order.Order.ChangeCar:output_type -> common.Response
