...
var file_order_order_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x32, 0xcd, 0x04, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x29, 0x0a, 0x03,
...
var file_order_order_proto_depIdxs = []int32{
	...
	4,  // 21: order.Order.Add:output_type -> order.Response
	4,  // 22: order.Order.Delete:output_type -> order.Response
	4,  // 23: order.Order.Update:output_type -> order.Response
	4,  // 24: order.Order.GetList:output_type -> order.Response
	4,  // 25: order.Order.GetDetail:output_type -> order.Response
	4,  // 26: order.Order.CancelOrder:output_type -> order.Response
	4,  // 27: order.Order.SaveDeliveryInfo:output_type -> order.Response
	18, // 28: order.Order.UpdateOrderStatus:output_type -> common.Response
	18, // 29: order.Order.UpdateCost:output_type -> common.Response
	18, // 30: order.Order.ChangeCar:output_type -> common.Response
	18, // 31: order.Order.CheckCarInvalidInOrder:output_type -> common.Response
