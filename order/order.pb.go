...
type Payment struct {
	...
	PaySuccess  bool   `protobuf:"varint,12,opt,name=paySuccess,proto3" json:"paySuccess,omitempty"`
}
...
func (x *Payment) GetPaySuccess() bool {
	if x != nil {
		return x.PaySuccess
	}
	return false
...
var file_order_order_proto_rawDesc = []byte{
	...
	0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x70,
