...
var file_order_order_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x04, 0x52, 0x03, 0x69, 0x64, 0x73, 0x32, 0xd3,
	0x05, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x29, 0x0a, 0x03, 0x41, 0x64, 0x64, 0x12,
	0x0f, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x44, 0x54, 0x4f,
...
var file_order_order_proto_depIdxs = []int32{
	...
	5,  // 24: order.Order.Add:output_type -> order.Response
	5,  // 25: order.Order.Delete:output_type -> order.Response
	5,  // 26: order.Order.Update:output_type -> order.Response
	5,  // 27: order.Order.GetList:output_type -> order.Response
	5,  // 28: order.Order.GetDetail:output_type -> order.Response
	5,  // 29: order.Order.CancelOrder:output_type -> order.Response
	5,  // 30: order.Order.SaveDeliveryInfo:output_type -> order.Response
	19, // 31: order.Order.UpdateOrderStatus:output_type -> common.Response
	19, // 32: order.Order.UpdateCost:output_type -> common.Response
	19, // 33: order.Order.ChangeCar:output_type -> common.Response
	19, // 34: order.Order.CheckCarInvalidInOrder:output_type -> common.Response
	19, // 35: order.Order.GetNoAssignCustomerByOrder:output_type -> common.Response
	19, // 36: order.Order.GetListWithPay:output_type -> common.Response
