...
var file_order_order_proto_rawDesc = []byte{
	...
	0x03, 0x69, 0x64, 0x73, 0x32, 0x90, 0x06, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x29,
...
var file_order_order_proto_depIdxs = []int32{
	...
	5,  // 25: order.Order.Add:output_type -> order.Response
	5,  // 26: order.Order.Delete:output_type -> order.Response
	5,  // 27: order.Order.Update:output_type -> order.Response
	5,  // 28: order.Order.GetList:output_type -> order.Response
	5,  // 29: order.Order.GetDetail:output_type -> order.Response
	5,  // 30: order.Order.CancelOrder:output_type -> order.Response
	5,  // 31: order.Order.SaveDeliveryInfo:output_type -> order.Response
	19, // 32: order.Order.UpdateOrderStatus:output_type -> common.Response
	19, // 33: order.Order.UpdateCost:output_type -> common.Response
	19, // 34: order.Order.ChangeCar:output_type -> common.Response
	19, // 35: order.Order.CheckCarInvalidInOrder:output_type -> common.Response
	19, // 36: order.Order.GetNoAssignCustomerByOrder:output_type -> common.Response
	19, // 37: order.Order.GetListWithPay:output_type -> common.Response
	19, // 38: order.Order.AssignOrderPIC:output_type -> common.Response
