...
var file_order_order_proto_rawDesc = []byte{
	...
	0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x92, 0x0d, 0x0a, 0x08, 0x4f, 0x72, 0x64, 0x65,
	...
	0x68, 0x61, 0x6e, 0x67, 0x65, 0x43, 0x61, 0x72, 0x46, 0x72, 0x6f, 0x6d, 0x22, 0x7c, 0x0a, 0x09,
...
var file_order_order_proto_goTypes = []interface{}{
	...
	(*CarIds)(nil),                       // 11: order.CarIds
	(*any.Any)(nil),                      // 12: google.protobuf.Any
	(*orderCheckList.CheckListDto)(nil),  // 13: orderCheckList.CheckListDto
	(*orderFee.OrderFeeDto)(nil),         // 14: orderFee.OrderFeeDto
	(*payment.PaymentList)(nil),          // 15: payment.PaymentList
	(*orderRefund.OrderRefundDto)(nil),   // 16: orderRefund.OrderRefundDto
	(*orderFlowLog.OrderFlowLogDto)(nil), // 17: orderFlowLog.OrderFlowLogDto
...
var file_order_order_proto_depIdxs = []int32{
	...
	12, // 2: order.Response.data:type_name -> google.protobuf.Any
	13, // 3: order.OrderCheckList.checkLists:type_name -> orderCheckList.CheckListDto
	1,  // 4: order.OrderDetail.orderDto:type_name -> order.OrderDTO
	14, // 5: order.OrderDetail.orderFees:type_name -> orderFee.OrderFeeDto
	15, // 6: order.OrderDetail.paymentDtos:type_name -> payment.PaymentList
	7,  // 7: order.OrderDetail.orderCheckList:type_name -> order.OrderCheckList
	16, // 8: order.OrderDetail.orderRefund:type_name -> orderRefund.OrderRefundDto
	17, // 9: order.OrderDetail.orderFlowLogs:type_name -> orderFlowLog.OrderFlowLogDto
	...
	1,  // 19: order.Order.ChangeCar:input_type -> order.OrderDTO
	11, // 20: order.Order.CheckCarInvalidInOrder:input_type -> order.CarIds
	0,  // 21: order.Order.QueryOrderForSendSms:input_type -> order.DeliveryInfo
	4,  // 22: order.Order.Add:output_type -> order.Response
	4,  // 23: order.Order.Delete:output_type -> order.Response
	4,  // 24: order.Order.Update:output_type -> order.Response
	4,  // 25: order.Order.GetList:output_type -> order.Response
	4,  // 26: order.Order.GetDetail:output_type -> order.Response
	4,  // 27: order.Order.CancelOrder:output_type -> order.Response
	4,  // 28: order.Order.SaveDeliveryInfo:output_type -> order.Response
	18, // 29: order.Order.UpdateOrderStatus:output_type -> common.Response
	18, // 30: order.Order.UpdateCost:output_type -> common.Response
	18, // 31: order.Order.ChangeCar:output_type -> common.Response
	18, // 32: order.Order.CheckCarInvalidInOrder:output_type -> common.Response
	18, // 33: order.Order.QueryOrderForSendSms:output_type -> common.Response
