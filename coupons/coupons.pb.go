...
type CouponNo struct {
	...
	CouponNo uint64 `protobuf:"varint,1,opt,name=CouponNo,proto3" json:"CouponNo,omitempty"`
}
...
func (x *CouponNo) GetCouponNo() uint64 {
	if x != nil {
		return x.CouponNo
	}
	return 0
...
var file_coupons_coupons_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x43, 0x6f, 0x75, 0x70, 0x6f, 0x6e, 0x4e, 0x6f, 0x22, 0xbd,
