...
var file_coupons_coupons_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xab, 0x03, 0x0a, 0x09, 0x43, 0x6f, 0x75, 0x70, 0x6f,
	...
	0x04, 0x6c, 0x69, 0x73, 0x74, 0x32, 0xc6, 0x01, 0x0a, 0x07, 0x43, 0x6f, 0x75, 0x70, 0x6f, 0x6e,
	...
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2d, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x6f, 0x75, 0x70, 0x6f,
...
var file_coupons_coupons_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_coupons_coupons_proto_goTypes = []interface{}{
	(*CouponDto)(nil),       // 0: coupons.CouponDto
	(*PagedList)(nil),       // 1: coupons.PagedList
...
var file_coupons_coupons_proto_depIdxs = []int32{
	2, // 0: coupons.PagedList.list:type_name -> google.protobuf.Any
	0, // 1: coupons.Coupons.Add:input_type -> coupons.CouponDto
	0, // 2: coupons.Coupons.Delete:input_type -> coupons.CouponDto
	0, // 3: coupons.Coupons.Update:input_type -> coupons.CouponDto
	3, // 4: coupons.Coupons.List:input_type -> common.Page
	4, // 5: coupons.Coupons.Add:output_type -> common.Response
	4, // 6: coupons.Coupons.Delete:output_type -> common.Response
	4, // 7: coupons.Coupons.Update:output_type -> common.Response
	4, // 8: coupons.Coupons.List:output_type -> common.Response
